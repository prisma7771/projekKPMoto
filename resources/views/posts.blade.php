...
@section('container')
	<div class="container rounded-3 bg-light bg-opacity-75 text-dark" >
 		...
 		<div class="row">
 			...
 			<div class="col-md-4 mb-3">
 				<div class="card border-dark">
 					<div class="position-absolute bg-dark px-3 py-2 text-white" style="background-color: rgba(0, 0, 0, .7);"><a href="/posts?category={{ $post->category->slug }}" class="text-white text-decoration-none">{{ $post->category->name }}</a></div>
